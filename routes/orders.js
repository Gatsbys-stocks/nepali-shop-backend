...
// POST /api/orders/:id/checkout — create a Stripe Checkout Session for an
// already-created order and return the payment URL. Public (the customer's
// own browser calls this right after placing the order).
router.post("/:id/checkout", async (req, res) => {
  try {
    ...
    updateOrder(order.id, { stripe_session_id: session.id });

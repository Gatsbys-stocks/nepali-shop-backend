...
- **Gestión del catálogo sin tocar código** — diseñé un CRUD de productos (`/api/products`) y un panel de administración para que el propio cliente del negocio añada, edite y borre productos —incluida la foto— sin depender de mí para cada cambio.
